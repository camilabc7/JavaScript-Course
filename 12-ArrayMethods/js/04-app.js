...
let resultado = carrito.filter((producto, index) => {
  if(producto.precio > 400){
      console.log(`El producto es ${producto.nombre} con index ${index}`);
  }
}); // Todos los mayores a 400 - añadir  && producto.precio < 600
